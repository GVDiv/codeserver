  ...
  if (online.statusCode === 200) {
    template = `
        <li id="facebook" class="header-li">
          <a class="header-a" href="https://www.facebook.com/gzeta1">
            <img
        ...
        <li id="instagram" class="header-li">
          <a class="header-a" href="https://www.instagram.com/el.munky/">
            <img
              class="header-social-img"
        ...
        <li id="cart" class="header-li">
          <a class="header-a" href="../../pages/cart.html">
            <img
              class="header-social-img"
        ...
        <li id="cart" class="header-li">
          <a class="header-a" href="../../pages/profile.html">
            <img
              class="header-social-img"
    ...
    template = `
        ...
        <li id="profile" class="header-li">
          <a class="header-a" href="../../pages/login.html">
            <img
              class="header-social-img"
